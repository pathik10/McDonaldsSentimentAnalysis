---
title: "Starter_Twitter_Analysis_Code"
output:
  html_document:
    df_print: paged
...
########################################################
```{r, echo=FALSE}
consumer_key="HL3yxWxpolOGvHaesV1r5spp3"
consumer_secret="BijK2ij1tZ0uGKyxgnHUnfzuZmixNHidl2ycGXexuDL664FrLE"
access_token="908831329764208642-wCm7TUnCZCWn6ZKScbEr4NnnIIF3LX2"
access_token_secret="WcSAEwFuGMuLdywz0s4F5DihcvtD9kfRjaNyuQSCSK9m1"
...
```
#Get tweets for keywords Verizon, Sprint, and TMobile and store them in separate dataframes
```{r}
Verizon=TweetFrame("#Verizon",5000,'2022-12-01')
Sprint=TweetFrame("#Sprint",5000,'2022-12-01')
TMobile=TweetFrame("#T-Mobile",5000,'2022-12-01')
